...
@section('title', 'Lakhtar News Update - Edit News')
...
@section('main')
    ...
    <div class="main-content-inner">
        ...
        @php
            ...
            $oldSelectedMediaIds = collect(old('selected_media_ids', []))->map(fn($id) => (int) $id)->all();
        @endphp
                ...
                <div class="news-sidebar">
                    ...
                    <div class="sidebar-card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="publish_date" id="publish_date" value="{{ old('publish_date', $news->publish_date ? $news->publish_date->format('Y-m-d') : date('Y-m-d')) }}" class="form-control">
                            @error('publish_date')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-toggle-group">
                                <label class="radio-toggle-label">
                                    <input type="radio" name="is_featured" value="1" {{ old('is_featured', $news->is_featured ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    <span>Yes</span>
                                </label>
                                <label class="radio-toggle-label">
                                    <input type="radio" name="is_featured" value="0" {{ old('is_featured', $news->is_featured ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    <span>No</span>
                                </label>
                            </div>
                            @error('is_featured')
                    ...
                    <div class="sidebar-card">
                        ...
                        <div class="form-group">
                            <label>Add From Media Library <span class="upload-optional">(Optional)</span></label>
                            ...
                            @else
                                <span class="upload-optional">No extra media available in library.</span>
                            @endif
                    ...
                    <div class="actions-card">
                        ...
                        <a href="{{ route('admin.news.index') }}" class="btn-block btn-reset" style="text-decoration:none; text-align:center;">
